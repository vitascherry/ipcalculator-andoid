...
public class View {
    ...
    public View(Context mAppContext) {
        this.mAppContext = mAppContext;
    }

    public void setIPAddressValue(TextView mIPAddressValue) { this.mIPAddressValue = mIPAddressValue; }

    public void setIPAddressBitString(TextView mIPAddressBitString) { this.mIPAddressBitString = mIPAddressBitString; }

    public void setNetmaskValue(TextView mNetmaskValue) { this.mNetmaskValue = mNetmaskValue; }

    public void setNetmaskBitString(TextView mNetmaskBitString) { this.mNetmaskBitString = mNetmaskBitString; }

    public void setWildcardValue(TextView mWildcardValue) { this.mWildcardValue = mWildcardValue; }

    public void setWildcardBitString(TextView mWildcardBitString) { this.mWildcardBitString = mWildcardBitString; }

    public void setNetworkValue(TextView mNetworkValue) { this.mNetworkValue = mNetworkValue; }

    public void setNetworkBitString(TextView mNetworkBitString) { this.mNetworkBitString = mNetworkBitString; }

    public void setBroadcastValue(TextView mBroadcastValue) { this.mBroadcastValue = mBroadcastValue; }

    public void setBroadcastBitString(TextView mBroadcastBitString) { this.mBroadcastBitString = mBroadcastBitString; }

    public void setMinHostValue(TextView mMinHostValue) { this.mMinHostValue = mMinHostValue; }

    public void setMinHostBitString(TextView mMinHostBitString) { this.mMinHostBitString = mMinHostBitString; }

    public void setMaxHostValue(TextView mMaxHostValue) { this.mMaxHostValue = mMaxHostValue; }

    public void setMaxHostBitString(TextView mMaxHostBitString) { this.mMaxHostBitString = mMaxHostBitString; }

    public void setMaxHostCountValue(TextView mMaxHostCountValue) { this.mMaxHostCountValue = mMaxHostCountValue; }
    ...
    public void printError(int errorMessageId) {
        Toast error = Toast.makeText(mAppContext, errorMessageId, Toast.LENGTH_LONG);
